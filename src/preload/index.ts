...
const api = {
  ...
  backupReduxData: () => ipcRenderer.send('backup-redux-data'),
  cleanupBeforeUpdate: () => ipcRenderer.send('cleanup-before-update'),
  onBackupReduxData: (callback) => ipcRenderer.on('backup-redux-data', callback),
